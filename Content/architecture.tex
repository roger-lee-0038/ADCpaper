...
%As the structure of the three main modules are described more specifically below, details of the three waves shown in Fig.~\ref{SSWAVE} are also revealed.
...
The signal waveform is shown in Fig.~\ref{SAR_pg}. It is noticed that for low-precision conversion, the ramp signal is generated as usual but the buffers and comparators will be power off, leaving the 4-bit results converted completely by SAR logic. 
