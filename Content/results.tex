...
\begin{figure}[htbp]
	...
	\caption{Average power characteristics of the SS ADC design.}
	\label{SSresults2}
\end{figure} 

\subsection{Energy-scaling Results of the SAR/SS ADC design}\label{SAR power}
...
\begin{figure}[htbp]
	...
	\caption{Average power characteristics of the SAR/SS ADC design.}
	\label{SARresults2}
\end{figure} 
...
\begin{table*}[htbp]
	...
	\begin{center}
		\begin{tabular}{|c|c|c|c|c|c|c|c|c|}
			...
			\hline
			\textbf{Precision(bits)} & 8 & 10 & 6 & 10 & 4 & 8 & 4 & 10 \\
			\hline
