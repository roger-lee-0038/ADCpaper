...
Sect.~\ref{architecture} presents the ADC architecture overview. 
Sect.~\ref{strategy} describes the implementation of the proposed method for the two ADC designs. 
Sect.~\ref{result} reports the evaluation results and Sect.~\ref{discussion} conduct further discussions. 
